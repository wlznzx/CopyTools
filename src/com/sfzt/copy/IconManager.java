...
public final class IconManager {
    ...
    private static final String BAIDU_MAP_DIR = "/storage/sdcard1/BaiduNaviHD";
    private static final String GAODE_MAP_DIR = "/storage/sdcard1/autonavidata70";
    private static final String KLD_MAP_DIR = "/storage/sdcard1/NaviOne";
...
//        }
    	String path = fileInfo.getFileAbsolutePath();
    	Log.w("map", "path: " + path);
    	if(path.equals(BAIDU_MAP_DIR)){
    		return getDefaultIcon(R.drawable.baidu);
    	} else if (path.equals(GAODE_MAP_DIR)){
    		return getDefaultIcon(R.drawable.gaode);
    	} else if (path.equals(KLD_MAP_DIR)){
    		return getDefaultIcon(R.drawable.kld);
    	} else {
    		return getFileIcon(R.drawable.fm_folder, false);
    	}
    }
