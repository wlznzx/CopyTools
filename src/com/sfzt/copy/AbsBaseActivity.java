...
import com.sfzt.copy.AlertDialogFragment.OnDialogDismissListener;
import com.sfzt.copy.FileInfoManager.NavigationRecord;
import com.sfzt.copy.MountReceiver.MountListener;
import com.sfzt.copy.service.FileManagerService;
import com.sfzt.copy.service.FileManagerService.ServiceBinder;
import com.sfzt.copy.service.ProgressInfo;
import com.sfzt.copy.utils.DrmManager;
import com.sfzt.copy.utils.LogUtils;
import com.sfzt.copy.utils.LongStringUtils;
import com.sfzt.copy.utils.PDebug;
import com.sfzt.copy.utils.ToastHelper;
...
public abstract class AbsBaseActivity extends Activity implements OnItemClickListener,
    ...
    protected class TabManager {
        ...
        public TabManager() {
            ...
            mBlankTab.setText(R.string.map_copy);
        ...
        public void refreshTab(String initFileInfo) {
            ...
            Log.d("file", "refreshTab.path: " + mCurrentPath);
...
//                    Log.d("file", "refreshTab.path1: " + path);
//                    String[] result = path.split(MountPointManager.SEPARATOR);
//                    for (String string : result) {
//                    	Log.d("file", "refreshTab.string: " + string);
//                        addTab(string);
//                    }
//
//                    if (getViewDirection() == ViewGroup.LAYOUT_DIRECTION_LTR) {
...
//            } else {
                homeBtn.setBackgroundDrawable(resources
                        .getDrawable(R.drawable.custom_home_ninepatch_tab));
                homeBtn.setImageDrawable(resources.getDrawable(R.drawable.copy));
//            }
        }
        ...
        protected void addTab(String text) {
            ...
            viewLikeBtn.setClickable(false);
    ...
    protected void showDirectoryContent(String path) {
        ...
        Log.d("file", "showDirectoryContent,path = " + path);
        if (isFinishing()) {
            Log.i("file", "showDirectoryContent,isFinishing: true, do not loading again");
            return;
        }
        mCurrentPath = path;
    ...
    protected void onPathChanged() {
        Log.d("file", "onPathChanged.path: " + mCurrentPath);
        if (mTabManager != null) {
    ...
    protected void toExternalDirection() {
    	...
    	File baidu_path = new File("/mnt/sdcard2/BaiduNaviHD/");
    	
        FileInfo selecteItemFileInfo = (FileInfo) mAdapter.getItem(1);
        Log.w("yy", "mAdapter: " + mAdapter);
        Log.w("yy", "mCurrentPath: " + mCurrentPath);
        Log.w("yy", "selecteItemFileInfo.getFileAbsolutePath(): " + selecteItemFileInfo.getFileAbsolutePath());
    ...
    protected class ListListener implements FileManagerService.OperationEventListener {
        ...
        public void onTaskResult(int result) {
            ...
            Log.i("file", "ListListener,TaskResult result = " + result);
            Log.i("file", "ListListener,TaskResult mCurrentPath = " + mCurrentPath);
            ...
            Log.i("file", "ListListener,TaskResult selectedItemPosition = " + selectedItemPosition);
