...
public class FileInfoManager {
    ...
    public void loadFileInfoList(String path, int sortType) {
        ...
        mLastAccessPath = path;
        mModifiedTime = (new File(mLastAccessPath)).lastModified();
        for(int i = 0; i < mAddFilesInfoList.size(); i++){
        	LogUtils.d(TAG, "mAddFilesInfoList.get(" + i + ").getFileName(): " + mAddFilesInfoList.get(i).getFileName());
        }
//        if (MountPointManager.getInstance().isRootPath(path)) {
//            mAddFilesInfoList.clear();
//            LogUtils.d(TAG, "loadFileInfoList, mAddFilesInfoList.clear");
...
//            Log.d("file", "mountFileList size = " + mountFileList.size());
...
//            Log.d("file", "fileInfoList size = " + fileInfoList.size());
