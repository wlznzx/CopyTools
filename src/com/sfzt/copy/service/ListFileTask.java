    ...
    protected Integer doInBackground(Void... params) {
        ...
        synchronized (mContext.getApplicationContext()) {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                LogUtils.d(TAG, "doInBackground, files[ + " + i + "].getName() = " + files[i].getName());
...
//                if(files[i].getName().equals(BAIDU_MAP_DIR) 
//                		|| files[i].getName().equals(GAODE_MAP_DIR)
//                		|| files[i].getName().equals(KLD_MAP_DIR))
