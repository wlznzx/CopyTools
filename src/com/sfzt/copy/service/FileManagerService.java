...
import com.sfzt.copy.MountPointManager;
import com.sfzt.copy.service.FileOperationTask.CopyPasteFilesTask;
import com.sfzt.copy.service.FileOperationTask.CreateFolderTask;
import com.sfzt.copy.service.FileOperationTask.CutPasteFilesTask;
import com.sfzt.copy.service.FileOperationTask.DeleteFilesTask;
import com.sfzt.copy.service.FileOperationTask.RenameTask;
...
public class FileManagerService extends Service {
    ...
    public FileInfoManager initFileInfoManager(String activityName) {
        ...
        Log.w("file", "activityInfo0: " + activityInfo);
        if (activityInfo == null) {
            ...
            Log.w("file", "activityInfo: " + activityInfo);
            Log.w("file", "activityName: " + activityName);
        }
